    ...
    <div className="text-white">
      ...
      <div className="">
        <div className="px-28 py-3 md:px-48">
          <h1 className="text-6xl font-impact">LEO CLUB</h1>
        </div>
        <div className="grid grid-cols-2 z-10 md:grid-cols-4  pt-10 w-4/5 mx-auto">
          {event.map((eve) => (
            <div
              key={eve._id}
              className="main mt-8 flex flex-col w-[250px] p-5 bg-gray-300 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 uppercase"
            >
              <img
